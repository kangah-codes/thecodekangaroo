/* hamburgers
   ...
   var forEach = function (e, t, r) {
    if ("[object Object]" === Object.prototype.toString.call(e)) for (var c in e) Object.prototype.hasOwnProperty.call(e, c) && t.call(r, e[c], c, e);
    else for (var a = 0, l = e.length; l > a; a++) t.call(r, e[a], a, e);
},
            ...
            c = (function () {
                function e(t, r) {
                    var o = r.location,
                        ...
                        x = void 0 === k ? 1 : k;
                    n(this, e),
                        (this.options = { location: i, distance: c, threshold: l, maxPatternLength: f, isCaseSensitive: v, tokenSeparator: g, findAllMatches: m, minMatchCharLength: x }),
                        (this.pattern = this.options.isCaseSensitive ? t : t.toLowerCase()),
                        this.pattern.length <= f && (this.patternAlphabet = s(this.pattern));
                }
                return (
                    o(e, [
                        {
                            ...
                            value: function (e) {
                                ...
                                return a(e, this.pattern, this.patternAlphabet, { location: s, distance: c, threshold: h, findAllMatches: l, minMatchCharLength: u });
                            },
                        },
                    ]),
                    e
                ...
                if (r) {
                    ...
                    if (null !== c && void 0 !== c)
                        if (s || ("string" != typeof c && "number" != typeof c))
                            if (n(c)) for (var h = 0, l = c.length; h < l; h += 1) e(c[h], s, o);
                            else s && e(c, s, o);
    ...
    function (e, t, r) {
        ...
        e.exports = function (e, t, r, i) {
            ...
            for (var L = [], w = 1, A = x + y, C = 1 << (x - 1), I = 0; I < x; I += 1) {
                for (var O = 0, F = A; O < F; ) {
                    n(t, { errors: I, currentLocation: g + F, expectedLocation: g, distance: h }) <= m ? (O = F) : (A = F), (F = Math.floor((A - O) / 2 + O));
                }
                A = F;
                ...
                for (var T = j; T >= P; T -= 1) {
                    ...
                    if (
                        (K && (S[E] = 1),
                        (z[T] = ((z[T + 1] << 1) | 1) & K),
                        0 !== I && (z[T] |= ((L[T + 1] | L[T]) << 1) | 1 | L[T + 1]),
                        z[T] & C && (w = n(t, { errors: I, currentLocation: E, expectedLocation: g, distance: h })) <= m)
                    ) {
                        if (((m = w), (k = E) <= g)) break;
                        P = Math.max(1, 2 * g - k);
                    }
            ...
            return { isMatch: k >= 0, score: 0 === w ? 0.001 : w, matchedIndices: o(S, p) };
        };
    },
    function (e, t, r) {
        "use strict";
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                if ("string" == typeof r[0]) {
                                    for (var i = 0, a = r.length; i < a; i += 1) this._analyze({ key: "", value: r[i], record: i, index: i }, { resultMap: n, results: o, tokenSearchers: e, fullSearcher: t });
                                ...
                                for (var s = {}, c = 0, h = r.length; c < h; c += 1)
                                    for (var l = r[c], u = 0, f = this.options.keys.length; u < f; u += 1) {
                                        ...
                                        this._analyze({ key: d, value: this.options.getFn(l, d), record: l, index: c }, { resultMap: n, results: o, tokenSearchers: e, fullSearcher: t });
                                    }
                                ...
                                if (void 0 !== i && null !== i) {
                                    ...
                                    if ("string" == typeof i) {
                                        ...
                                        if ((this._log("\nCheck Matches: " + j), (y || x.isMatch) && j)) {
                                            var z = v[c];
                                            z
                                                ? z.output.push({ key: r, arrayIndex: o, value: i, score: P, matchedIndices: x.matchedIndices })
                                                : ((v[c] = { item: a, output: [{ key: r, arrayIndex: o, value: i, score: P, matchedIndices: x.matchedIndices }] }), g.push(v[c]));
                                        }
                                    } else if (s(i))
                                        for (var T = 0, E = i.length; T < E; T += 1) this._analyze({ key: r, arrayIndex: T, value: i[T], record: a, index: c }, { resultMap: v, results: g, tokenSearchers: l, fullSearcher: f });
                                }
                            },
                        },
                        {
                                ...
                                for (var r = 0, n = t.length; r < n; r += 1) {
                                    for (var o = t[r].output, i = o.length, a = 1, s = 1, c = 0; c < i; c += 1) {
                                        var h = e ? e[o[c].key].weight : 1,
                                            l = 1 === h ? o[c].score : o[c].score || 0.001,
                                            u = l * h;
                        ...
                        s.status >= 200 &&
                            ...
                            (a.onkeyup = function (e) {
                                if (
                                    ((i.innerHTML = ""),
                                    (o.innerHTML = ""),
                                    this.value.length > 2 && (r.classList.add("hide"), c.classList.remove("hide")),
                                    this.value.length < 3 && (r.classList.remove("hide"), c.classList.add("hide")),
                                    !(this.value.length <= 2))
                                ) {
                                    var n = t.search(e.target.value);
                                    (i.innerHTML = n.length),
                                        n.map(function (e) {
                                            var t = new Date(e.published_at).toLocaleDateString(document.documentElement.lang, { year: "numeric", month: "long", day: "numeric" }),
                                                n = document.createElement("h4");
                                            (n.textContent = e.title),
                                                (n.innerHTML += '<span class="search-date">' + searchPublished + " — " + t + "</span>"),
                                                e.featured && (n.innerHTML += '<span class="search-featured">' + searchFeaturedIcon + "</span>");
